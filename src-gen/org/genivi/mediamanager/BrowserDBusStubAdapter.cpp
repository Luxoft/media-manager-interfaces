...
const char* BrowserDBusStubAdapterInternal::getMethodsDBusIntrospectionXmlData() const {
    static const std::string introspectionData =
        ...
        "<signal name=\"lostServer\">\n"
            "<arg name=\"serverIdentifier\" type=\"s\" />\n"
        "</signal>\n"
        /**
         * Emitted when the list of media managers has changed.
         */
 ...
 * Emitted when the list of media managers has changed.
 */
void BrowserDBusStubAdapterInternal::fireLostServerEvent(const std::string& serverIdentifier) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<std::string>>
            ::sendSignal(
                *this,
                "lostServer",
                "s",
 ...
 * Emitted when the list of media managers has changed.
 */
void BrowserDBusStubAdapterInternal::fireFoundServerEvent(const std::string& serverIdentifier) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<std::string>>
            ::sendSignal(
                *this,
                "foundServer",
